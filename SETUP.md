...
git clone https://github.com/seu-usuario/jogai.git # SUBSTITUA PELO LINK CORRETO DO SEU REPOSITÓRIO
cd jogai
...
5. Defina o "padrão" para sua primeira aventura e comece a interagir no chat!
